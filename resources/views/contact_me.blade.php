@extends('layouts.app')
@section('title', 'AppifyLab | Contact Admin')
@section('maincontent')
		<!-- BANNER -->
							...
							<div class="col-12 col-md-3 col-lg-3">
								<div class="me_prfl_left">
									<div class="me_prfl_left_top_img">
										<img src="/img/about_me.jpg" alt="image">
									</div>
									<div class="me_cntct">
										<h4 class="me_cntct_title">Contact Info</h4>
										<ul class="me_cntct_ul">
											<li>
												<i class="fa fa-envelope"></i> Email: nomanabdullah.dev@gmail.com
											</li>
											<li class="me_phn">
												<i class="fa fa-phone"></i>
												Phone: +88 01521 497845
											</li>
										</ul>
									</div>
									<div class="me_social mar_t30">
										<ul class="me_social_ul d-flex">
											<li>
												<a href="https://www.facebook.com/nomanabdullah.dev">
							...
							<div class="col-12 col-md-9 col-lg-9">
								<div class="me_prfl_r8">
									<div class="me_prfl_name">
										<h2 class="me_cntct_name">Noman Abdullah</h2>
